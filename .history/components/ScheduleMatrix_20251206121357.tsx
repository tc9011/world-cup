              ...
              return regionVenues.map((venue, index) => (
                <tr key={venue.id} className="group hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                  ...
                  {index === 0 && (
                    ...
                    >
                      <div className="h-full w-full flex items-center justify-center writing-vertical-rl rotate-180 text-xs font-bold text-gray-600 dark:text-gray-400 uppercase tracking-widest py-4">
                        {region} Region
                      </div>
                    </td>
                  )}
